          ...
          <div class="row">
            <div class="col-md-3">
              <ul class="list-unstyled profile-nav">
                <li>
                  <img src="<?php echo base_url('images/thumb_create/?image=' . base64_encode($book_data->book_source)) ?>" class="img-responsive pic-bordered" alt="<?php echo $book_data->book_name ?>" />
                </li>
