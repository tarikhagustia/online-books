...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <?php
            echo form_open('forget/password/save', ['class' => 'daftar-form']);
            echo form_hidden('key', set_value('key', $this->input->get('key')));
            ?>
                <div class="form-title">
                    <span class="form-title">Lupa Kata sandi</span>
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Katasandi Baru</label>
                    <input class="form-control placeholder-no-fix" type="password" placeholder="Katasandi Baru" name="newPassword" value="<?php echo set_value('newPassword') ?>" required />
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Konfirmasi Katasandi Baru</label>
                    <input class="form-control placeholder-no-fix" type="password" placeholder="Konfirmasi Katasandi Baru" name="confirmNewPassword" value="<?php echo set_value('confirmNewPassword') ?>" required />
                </div>
